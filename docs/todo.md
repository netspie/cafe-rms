...
- [ ] **Session 5 — Events + EventDays.** Closed business process #2. Event create / publish / cancel + EventDays add/remove + close-event-with-loyalty-payout. ~9 endpoints + ~12 tests. Estimated ~400–500k tokens.
