    ...
    <div className="space-y-6">
      ...
      <form action={createTemplate} className="flex items-end gap-3 rounded-md border bg-card p-3">
        ...
        <Field label="Template file URL">
          <input name="templateFileUrl" required className="h-9 w-72 rounded-md border bg-transparent px-3 text-sm outline-none focus:border-ring focus:ring-2 focus:ring-ring/30" />
        </Field>
