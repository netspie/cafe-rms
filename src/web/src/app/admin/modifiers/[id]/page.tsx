  ...
  return (
    <div className="space-y-6">
      ...
      <form action={updateModifier} className="max-w-xl space-y-4">
        ...
        <Field label="Price delta" hint="Added to the product price (can be negative).">
          <input name="priceDelta" type="number" step="0.01" defaultValue={item.priceDelta} required className="h-9 w-full rounded-md border bg-transparent px-3 text-sm outline-none focus:border-ring focus:ring-2 focus:ring-ring/30" />
        </Field>
